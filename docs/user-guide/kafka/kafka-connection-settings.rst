...
Instances of this model have properties that can be used to construct different types of `Kafka`_ clients:
...
If your application is running in Phalanx, you likely should be using the `Sasquatch`_-managed Kafka cluster, and generating the necessary values `like this <https://sasquatch.lsst.io/user-guide/directconnection.html>`__.
