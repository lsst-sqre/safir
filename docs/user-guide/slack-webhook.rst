...
.. tip::
   ...
   Consider using `~safir.sentry.notify` to post your exceptions. This will post them to either Slack, or Sentry, or both, depending on what is configured in your app.
