...
After the dependencies are locked, commit the uv lockfile and any other files modified by :command:`make update`:

.. prompt:: bash

   git add uv.lock .github/workflows Dockerfile
   git commit
