...
class SentryConfig(BaseSettings):
    ...
    release: Annotated[
        ...
        Field(
            ...
            description=("The version of this application that is deployed."),
        ),
    ]
...
def initialize_sentry(**additional_kwargs: dict[str, Any]) -> None:
    ...
    `~safir.sentry.before_send_handler` so that `~safir.SentryException` values
    can be used.
    """
    ...
    sentry_sdk.init(before_send=before_send_handler, **kwargs)
